...
function FileSelected(file){
   ...
   */
    ...
    //if (!output && output != "") window.opener.document.getElementById("output").value = file.fullPath;
    //if (!imgshow && imgshow != "") window.opener.document.getElementById("output").src = file.fullPath;
