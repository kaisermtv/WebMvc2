...
namespace WebMvc.Application
{
    public class SiteConstants
    {
        ...
        private SiteConstants(ConfigService configService)
        {
            ...
            get
            {
                if (_instance == null)
                {
                    lock (InstanceLock)
                    {
                        if (_instance == null)
                        {
                            var configService = DependencyResolver.Current.GetService<ConfigService>();
        ...
        public string UploadCarouselFolderPath => GetConfig("UploadCarouselFolderPath");
        ...
        public string GroupProductUrlIdentifier => GetConfig("GroupProductUrlIdentifier");
